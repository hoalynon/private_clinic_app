...
public class CaBenh implements KeyListener{
	...
	CaBenh(BNHome MyHome){
		...
		JLabel labelHeading = new JLabel("DANH SACH BENH AN");
...
public void setInformation() { 
		...
		try {
			...
			CallableStatement statement = connection.prepareCall("{ call rootdata.proc_cabenh_laycabenh_theobenhnhan (?,?) }");
			...
			data.setColumnIdentifiers(new String[] {"Ma Ca","Ma BS","Ma Benh","Ten Benh","Muc Do","Hinh Thuc","Bat Dau","Ket Thuc","Tinh Trang","Ma Phong"});
			data.setRowCount(0);
