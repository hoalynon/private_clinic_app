...
public class KeThuoc implements KeyListener{
	...
	KeThuoc(BSHome MyHome){
		...
		JLabel labelHeading = new JLabel("DANH SACH BANG KE THUOC DA TAO");
...
public void setInformation() { 
		...
		try {
			...
			CallableStatement statement = connection.prepareCall("{ call rootdata.proc_kethuoc_laykethuoc_theobs (?,?) }");
			...
			data.setColumnIdentifiers(new String[] {"Ma Ca","Ma Thuoc","Ten Thuoc","Ngay Ke","So Luong"});
			data.setRowCount(0);
