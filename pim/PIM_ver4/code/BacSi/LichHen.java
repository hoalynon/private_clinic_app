...
public class LichHen implements KeyListener{
	...
	LichHen(BSHome MyHome){
		...
		JLabel labelHeading = new JLabel("DANH SACH LICH HEN DANG CHO");
...
public void setInformation() { 
		...
		try {
			...
			CallableStatement statement = connection.prepareCall("{ call rootdata.proc_lichhenkham_laylichhenkham_theobacsi (?,?) }");
			...
			data.setColumnIdentifiers(new String[] {"Ma Lich","Ma BN","Ngay Du Kien", "Nhu Cau Kham"});
			data.setRowCount(0);
