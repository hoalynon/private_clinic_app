...
public class ThietBiYTe implements KeyListener{
...
public void setInformation() { 
		...
		try {
			...
			data.setColumnIdentifiers(new String[] {"Ma Thiet Bi","Ten Thiet Bi","Loai SD","Cong Dung","So Luong Tong","So Luong Con Lai"});
			data.setRowCount(0);
