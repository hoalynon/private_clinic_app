...
public class LichHen implements KeyListener{
	...
	LichHen(QLHome MyHome){
		...
		JLabel labelHeading = new JLabel("DANH SACH LICH HEN DA XAC NHAN");
...
public void setInformation() { 
		...
		try {
			...
			CallableStatement statement = connection.prepareCall("{ call rootdata.proc_lichhenkham_laylichhenkham_quanly (?) }");
			...
			data.setColumnIdentifiers(new String[] {"Ma Lich","Ma BN","Ma BS","Ten BS","Ngay Du Kien", "Nhu Cau Kham"});
			data.setRowCount(0);
